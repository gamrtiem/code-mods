...
public class WoodToolkit : ItemBase<WoodToolkit>
{
    ...
    public override string ItemPickupDesc => "Interacting with <style=\"cIsHealing\">Shrines of the Wood</style> gives you <style=\"cIsUtility\">bark</style>, droping after 2 seconds, creating a <style=\"cIsHealing\">healing aura</style>. Guarantee a free Shrine of the Woods spawn.";
    public override string ItemFullDescription => "After interacting with a <style=\"cIsHealing\">Shrine of the Woods</style>, gain a piece of <style=\"cIsUtility\">bark</style> that drops after standing still for <style=\"cIsHealing\">2</style> seconds, healing for <style=\"cIsHealing\">6%</style> <style=\"cStack\">(+4% per stack)</style> of your health every second to all allies within <style=\"cIsHealing\">7m</style> <style=\"cStack\">(+4m per stack)</style>. Guarantee a free Shrine of the Woods spawn.";
    ...
    private void SceneDirectorOnonPostPopulateSceneServer(SceneDirector obj)
    {
        ...
        if (gameObject.TryGetComponent(out ModelLocator modelLocator))
        {
    ...
    private static GameObject mushroomWardPrefab = Addressables.LoadAssetAsync<GameObject>(RoR2BepInExPack.GameAssetPathsBetter.RoR2_Base_Mushroom.MushroomWard_prefab).WaitForCompletion();
    private InteractableSpawnCard spawnCard = Addressables.LoadAssetAsync<InteractableSpawnCard>(RoR2BepInExPack.GameAssetPaths.Version_1_35_0.RoR2_Base_ShrineHealing.iscShrineHealing_asset).WaitForCompletion();
